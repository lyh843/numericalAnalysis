...
class ImportanceGaussianInitializer:
    ...
    def initialize(self, model: Gaussian2DModel, target_image: torch.Tensor | None = None) -> None:
        ...
        # # Similar to 3DGS using nearest-neighbor spacing to initialize Gaussian size:
        # # denser regions start sharper, sparse regions start broader.
        # sigma_init = 0.5 * local_spacing
        # sigma_init = sigma_init.clamp(0.003, 0.08)
